...
Firstly follow the steps given to setup SSH connection to wilson. These can be found by importing the fast_rsm module and then running the command ssh-instructions
